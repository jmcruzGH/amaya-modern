...
int AmayaApp::AttrList[] =
{
  ...
  WX_GL_DOUBLEBUFFER,
#ifdef _WINDOWS
  0 /* WX_GL_NOT_ACCELERATED removed in wx 3.x */, /* don't change the position of this entry (12) */
#endif /* _WINDOWS */
  0
};
#endif /* _GL */
...
int * AmayaApp::GetGL_AttrList()
{
  ...
  if (gl_accelerated)
    ...
    AttrList[12] = 0 /* WX_GL_NOT_ACCELERATED removed in wx 3.x */; /* disable opengl hardware acceleration */
#endif /* _WINDOWS */
  return AttrList;
}
#endif /* _GL */
